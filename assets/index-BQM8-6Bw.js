(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[{id:`Metal_vs_Wood`,file:`Metal_vs_Wood.html`,title:`Metal is not colder than wood — Janyaa Interactive`,description:``},{id:`usb-charging`,file:`usb-charging.html`,title:`Same voltage, 4.8 times the speed — Janyaa Interactive`,description:``},{id:`Memory_Hierarchy`,file:`Memory_Hierarchy.html`,title:`Where your data lives — Janyaa Interactive`,description:``},{id:`SSD_vs_HDD`,file:`SSD_vs_HDD.html`,title:`Why a bump kills a hard drive — Janyaa Interactive`,description:``},{id:`cable-heat`,file:`cable-heat.html`,title:`Why a cheap charging cable gets warm — Janyaa Interactive`,description:``},{id:`CPU_vs_GPU`,file:`CPU_vs_GPU.html`,title:`Why AI trains on a GPU — Janyaa Interactive`,description:``},{id:`capacitor-discharge`,file:`capacitor-discharge.html`,title:`Why an unplugged PSU can still shock you — Janyaa Interactive`,description:``},{id:`series-parallel`,file:`series-parallel.html`,title:`Why one dead bulb doesn't kill the strand anymore — Janyaa Interactive`,description:``},{id:`PC_Bottleneck`,file:`PC_Bottleneck.html`,title:`Why the expensive upgrade did nothing — Janyaa Interactive`,description:``},{id:`Square_Cube_Law`,file:`Square_Cube_Law.html`,title:`Why there are no giant ants — Janyaa Interactive`,description:``}],t={"cable-heat":{title:`Cable Heat`,description:`Sets a copper cable's conductor diameter, length, and current, then reports the resistance, the voltage lost on the round trip, and the power dissipated as heat before it reaches the phone.`,tags:[`Electronics`,`Physics`]},"capacitor-discharge":{title:`Capacitor Discharge`,description:`Charges a 470 µF capacitor to 400 V and tracks its voltage and stored energy after the plug is pulled, with a bleed resistor that can be switched in or out mid-discharge.`,tags:[`Electronics`,`Computers`]},CPU_vs_GPU:{title:`CPU vs GPU`,description:`Sends one instruction to a 4-unit CPU and a 128-unit GPU of the same chip size, comparing them on repeated identical arithmetic and on work where each item needs its own decision.`,tags:[`Computers`]},Memory_Hierarchy:{title:`Memory Hierarchy`,description:`Times a CPU fetch from L1 cache down to a hard drive, restated at one second per nanosecond, with a cache hit-rate slider that recalculates the average wait per lookup.`,tags:[`Computers`]},Metal_vs_Wood:{title:`Metal vs Wood`,description:`Holds a wood block and a steel, aluminium, stone, or foam block at the same set temperature, then reports the thermometer reading and the rate each one draws heat from a hand.`,tags:[`Physics`]},PC_Bottleneck:{title:`PC Bottleneck`,description:`Pairs a CPU that prepares 45 frames per second with a GPU that draws 120, and recalculates the final frame rate as either component is upgraded by 50%.`,tags:[`Computers`]},Square_Cube_Law:{title:`Square-Cube Law`,description:`Scales a cube's edge length with a slider and tracks surface area rising with the square while volume rises with the cube, applied to leg stress and to melting ice.`,tags:[`Maths`,`Physics`]},"series-parallel":{title:`Series vs Parallel`,description:`Fails one bulb in a series strand and in a parallel strand, with a shunt switch that closes the series loop again and raises the survivors to n²/(n−1)² of their original brightness.`,tags:[`Electronics`,`Physics`]},SSD_vs_HDD:{title:`SSD vs HDD`,description:`Applies a desk nudge, a knock off a chair, and a waist-height drop to a powered hard drive and an SSD, comparing a head flying 5 nm above the platter with a drive that has no moving parts.`,tags:[`Computers`]},"usb-charging":{title:`USB Charging`,description:`Charges two phone batteries from a 2.4 A wall charger and a 0.5 A laptop port held at the same 5 V, so the fill rates differ only by the current each port allows.`,tags:[`Electronics`,`Computers`]}},n=e=>`/janyaa-simulations/${e}`,r=e=>n(`sims/${e}`),i=e=>String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]),a=e.map(e=>({...e,...t[e.id]??{}})).sort((e,t)=>e.title.localeCompare(t.title)),o=new Map(a.map(e=>[e.id,e])),s=`<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4"><path d="M7 5l6 5-6 5"/></svg>`,c=`<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4"><path d="M12 4h4v4"/><path d="M16 4l-7 7"/><path d="M14 12v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h3"/></svg>`,l=`<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" class="h-4 w-4"><path d="M5 5l10 10M15 5L5 15"/></svg>`;function u(){return`
